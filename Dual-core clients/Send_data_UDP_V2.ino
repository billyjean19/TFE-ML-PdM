...
const char * serverIP = "XXXXX";  // public IP address from ifconfig
...
// Batch variables
#define MAX_BATCH_SIZE 250 //250 // Maximum number of data points to collect before sending batch
...
void setup() {
  ...
  udp.begin(WiFi.localIP(), 0); // Choose any available local port (0 for automatic assignment)
...
void TaskSendData(void* pvParameters) {
  ...
  for (;;) {
    ...
    #ifdef PERFORMANCE
    Serial.print("[Core ");Serial.print(xPortGetCoreID());Serial.print("] Time taken send data: "); Serial.print((t3-t2)); Serial.println(" milliseconds");
    #endif
  }
}
